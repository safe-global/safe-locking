...
dotenv.config()
const { CUSTOM_NODE_URL, INFURA_KEY, MNEMONIC, ETHERSCAN_API_KEY, PK, SOLIDITY_VERSION, SOLIDITY_SETTINGS, OWNER } = process.env
...
const forking = process.env['HARDHAT_FORK'] ? { forking: { enabled: true, url: `https://mainnet.infura.io/v3/${INFURA_KEY}` } } : {}
